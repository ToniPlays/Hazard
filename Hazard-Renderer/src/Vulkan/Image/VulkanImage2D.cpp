...
namespace HazardRenderer::Vulkan
{
	...
	VulkanImage2D::~VulkanImage2D()
	{
		...
		const auto device = VulkanContext::GetPhysicalDevice().GetVulkanDevice();
	...
	void VulkanImage2D::RT_Invalidate()
	{
		...
		if (m_Info.Usage == ImageUsage::Storage)
		{
			...
			VkCommandBuffer commandBuffer = VulkanContext::GetPhysicalDevice().GetCommandBuffer(true);
			...
			VulkanContext::GetPhysicalDevice().FlushCommandBuffer(commandBuffer);
		}
