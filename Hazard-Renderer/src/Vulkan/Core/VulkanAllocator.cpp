...
//
//		//HZR_CORE_WARN("VulkanAllocator ({0}) allocated {1}", m_Tag, StringUtil::BytesToString(info.size));
...
//		s_Data->TotalAllocated -= info.size;
//		//HZR_CORE_WARN("Total allocated {0}", StringUtil::BytesToString(s_Data->TotalAllocated));
//
