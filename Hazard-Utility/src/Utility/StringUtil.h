...
public:
	...
	static size_t OffsetOf(const std::string& source, char delim, uint32_t startOffset = 0);
	static size_t OffsetOf(const std::string& source, const std::string& value, uint32_t startOffset = 0);
