...
namespace Hazard {
    ...
    GUIPlatformMetal::GUIPlatformMetal(HazardRenderer::Window& window)
    {
    ...
    GUIPlatformMetal::~GUIPlatformMetal()
    {
    #ifdef HZR_PLATFORM_MACOS
    ...
    void GUIPlatformMetal::BeginFrame()
    {
        using namespace HazardRenderer::Metal;
    ...
    void GUIPlatformMetal::EndFrame()
    {
        using namespace HazardRenderer::Metal;
