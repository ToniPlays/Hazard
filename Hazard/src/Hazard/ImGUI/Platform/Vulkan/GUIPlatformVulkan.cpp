...
namespace Hazard
{
	...
	GUIPlatformVulkan::GUIPlatformVulkan(HazardRenderer::Window& window)
	{
	...
	GUIPlatformVulkan::~GUIPlatformVulkan()
	{
		ImGui_ImplVulkan_Shutdown();
		ImGui_ImplGlfw_Shutdown();
	}

	void GUIPlatformVulkan::BeginFrame()
	{
	...
	void GUIPlatformVulkan::EndFrame()
	{
		using namespace HazardRenderer::Vulkan;
