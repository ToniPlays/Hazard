...
namespace ImGui
{
    static bool TreeNodeWithIcon(ImGuiID id, ImGuiTreeNodeFlags flags, const char* label, const char* label_end, ImColor iconTint = IM_COL32_WHITE)
    {
        ...
        const ImU32 arrow_col = ImGui::ColorConvertFloat4ToU32({ 255, 255, 255, 255 });
    ...
    static bool TreeNodeWithIcon(const void* ptr_id, ImGuiTreeNodeFlags flags, ImColor iconTint, const char* fmt, ...)
    {
        ...
        bool is_open = TreeNodeWithIcon(window->GetID(ptr_id), flags, g.TempBuffer, label_end, iconTint);
